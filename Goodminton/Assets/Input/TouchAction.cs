...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/TouchAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TouchAction: IInputActionCollection2, IDisposable
{
    ...
    ~@TouchAction()
    {
        UnityEngine.Debug.Assert(!m_General.enabled, "This will cause a leak and performance issues, TouchAction.General.Disable() has not been called.");
    }
